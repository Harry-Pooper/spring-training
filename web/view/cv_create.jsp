...
<div class="main_box">
    <form:form method="POST" modelAttribute="cvInfo" enctype="multipart/form-data">
        ...
        <spring:bind path="email">
            <div class="${status.error ? 'has-error' : ''}">
                <form:input type="text" path="email" maxlength="60" placeholder="E-mail" class="common-input-field"></form:input>
        ...
        От
        <input type="number" id="paymentFrom" name="paymentFrom" class="common-input-small-field" placeholder="От">
        До
        <input type="number" id="paymentTo" name="paymentTo" class="common-input-small-field" placeholder="До">руб.<br/>
        ...
        <input type="submit" name="btnCancel" value="Отменить" class="common-button"/>
        <input type="hidden" id="cvImg" name="cvImg" value=""/>
